...
<CardGroup cols={2}>
  <Card title="Start an off-label record" icon="fa-regular fa-file-medical" href="/california-off-label/start">
    Provider-facing workflow for California off-label prescribing, evidence, consent, documentation, and coverage.
  </Card>
