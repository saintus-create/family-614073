...
<video
  ...
  playsInline
  preload="auto"
  poster="https://svs.gsfc.nasa.gov/vis/a030000/a031100/a031110/day-night-california_vir_2012271_lrg_00000_print.jpg"
  style={{position: "fixed", top: "-4vh", left: "-4vw", width: "108vw", height: "108vh", objectFit: "cover", objectPosition: "center", opacity: 0.13, mixBlendMode: "screen", filter: "blur(0.35px)", pointerEvents: "none", zIndex: 0, animation: "cei-map-drift 38s ease-in-out infinite alternate"}}
  aria-hidden="true"
>
  <source src="https://svs.gsfc.nasa.gov/vis/a030000/a031100/a031110/day-night-california_vir_2012271_lrg_1080p30.webm" type="video/webm" />
...
<style>
{`@keyframes cei-map-drift {
  0% { transform: scale(1.02) translate3d(-0.5%, -0.25%, 0); }
  100% { transform: scale(1.09) translate3d(0.7%, 0.45%, 0); }
}

@media (prefers-reduced-motion: reduce) {
  video[aria-hidden="true"] { animation: none !important; }
}`}
</style>
