...
<Badge intent="warning">Case report</Badge> <Badge intent="info" minimal>2025</Badge> <Badge intent="note" minimal outlined>Efficacy</Badge> <Badge intent="note" minimal outlined>Safety & tolerability</Badge> <Badge intent="note" minimal outlined>Cognition & function</Badge> <Badge intent="note" minimal outlined>Comorbidity</Badge> <Badge intent="success" minimal>Free full text</Badge>
