...
<Badge intent="success">Systematic review</Badge> <Badge intent="info" minimal>2026</Badge> <Badge intent="note" minimal outlined>Efficacy</Badge> <Badge intent="note" minimal outlined>Safety & tolerability</Badge> <Badge intent="note" minimal outlined>Epidemiology & utilization</Badge>
