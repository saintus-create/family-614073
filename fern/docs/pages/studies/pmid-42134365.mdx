...
subtitle: "Lancet Psychiatry · 2026 · PMID 42134365"
slug: pmid-42134365
---

<Badge intent="success">Systematic review</Badge> <Badge intent="info" minimal>2026</Badge> <Badge intent="note" minimal outlined>Efficacy</Badge> <Badge intent="note" minimal outlined>Safety & tolerability</Badge> <Badge intent="note" minimal outlined>Epidemiology & utilization</Badge> <Badge intent="tip" minimal>Titrated to effect</Badge>

## Record

| Field | Value |
|---|---|
| Authors | Nourredine M, Jurek L, Hamza T, Cipriani A, Subtil F, Parlatini V, Farhat LC, Veronesi GF, Efthimiou O, Salanti G, Cortese S |
...
| Country | United States, United Kingdom, Italy, France, Switzerland, Brazil |
| Dosing regimen | Titrated to effect |
| Doses named | 4 mg/day, 25 mg/day, 45 mg/day, 50 mg/day |
| Language | English |
| Sources | [PubMed 42134365](https://pubmed.ncbi.nlm.nih.gov/42134365/) · [DOI 10.1016/S2215-0366(26)00091-X](https://doi.org/10.1016/S2215-0366(26)00091-X) |
...
<Badge intent="note" minimal outlined>Humans</Badge> <Badge intent="note" minimal outlined>Attention Deficit Disorder with Hyperactivity</Badge> <Badge intent="note" minimal outlined>Dose-Response Relationship, Drug</Badge> <Badge intent="note" minimal outlined>Central Nervous System Stimulants</Badge> <Badge intent="note" minimal outlined>Child</Badge> <Badge intent="note" minimal outlined>Randomized Controlled Trials as Topic</Badge> <Badge intent="note" minimal outlined>Adolescent</Badge> <Badge intent="note" minimal outlined>Adult</Badge> <Badge intent="note" minimal outlined>Female</Badge>

## Cite this record

<Callout intent="info">
Nourredine M, Jurek L, Hamza T, Cipriani A, Subtil F, Parlatini V, et al. Pharmacological interventions for ADHD: a systematic review and dose-effect network meta-analysis. Lancet Psychiatry. 2026. doi:10.1016/S2215-0366(26)00091-X. PMID:42134365.
</Callout>
...
<CardGroup cols={2}>
  ...
  <Card title="Treatment Outcomes With Licensed and Unlicensed Stimulant Doses for Adul..." icon="fa-regular fa-list-check" href="/pmid-37878348">
    JAMA Psychiatry · 2024 · Systematic review
  </Card>
