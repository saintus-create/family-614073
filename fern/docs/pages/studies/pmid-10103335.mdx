...
<Badge intent="check">Randomized controlled trial</Badge> <Badge intent="info" minimal>1999</Badge> <Badge intent="note" minimal outlined>Efficacy</Badge> <Badge intent="note" minimal outlined>Safety & tolerability</Badge> <Badge intent="note" minimal outlined>Pharmacokinetics</Badge> <Badge intent="note" minimal outlined>Cognition & function</Badge>
