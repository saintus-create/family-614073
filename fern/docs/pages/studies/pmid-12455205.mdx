...
<Badge intent="note">Review</Badge> <Badge intent="info" minimal>2002</Badge> <Badge intent="note" minimal outlined>Safety & tolerability</Badge> <Badge intent="note" minimal outlined>Epidemiology & utilization</Badge> <Badge intent="tip" minimal>Extended release</Badge>
