...
<Badge intent="note">Review</Badge> <Badge intent="info" minimal>2017</Badge> <Badge intent="note" minimal outlined>Growth & development</Badge> <Badge intent="note" minimal outlined>Pharmacokinetics</Badge>
