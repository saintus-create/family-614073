...
subtitle: "Lancet Psychiatry · 2018 · PMID 30097390"
slug: pmid-30097390
---

<Badge intent="success">Systematic review</Badge> <Badge intent="info" minimal>2018</Badge> <Badge intent="note" minimal outlined>Efficacy</Badge> <Badge intent="note" minimal outlined>Safety & tolerability</Badge> <Badge intent="success" minimal>Free full text</Badge>

## Record

| Field | Value |
|---|---|
| Authors | Cortese S, Adamo N, Del Giovane C, Mohr-Jensen C, Hayes AJ, Carucci S, Atkinson LZ, Tessari L, Banaschewski T, Coghill D, Hollis C, Simonoff E, et al. (19 authors) |
| Journal | Lancet Psychiatry |
| Year | 2018 |
| Study design | Systematic review |
| Publication types | Comparative Study, Journal Article, Research Support, Non-U.S. Gov't, Systematic Review, Network Meta-Analysis |
| Population | Children, Adolescents, Adults |
| Country | United States, United Kingdom, Germany, Denmark, Italy, Switzerland, China, Iran, Australia |
| Dosing regimen | Not stated in abstract |
| Doses named | None named in abstract |
| Language | English |
| Sources | [PubMed 30097390](https://pubmed.ncbi.nlm.nih.gov/30097390/) · [DOI 10.1016/S2215-0366(18)30269-4](https://doi.org/10.1016/S2215-0366(18)30269-4) · [PMC6109107 full text](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6109107/) |
...
**Funding:** Stichting Eunethydis (European Network for Hyperkinetic Disorders), and the UK National Institute for Health Research Oxford Health Biomedical Research Centre.

## MeSH terms

<Badge intent="note" minimal outlined>Adolescent</Badge> <Badge intent="note" minimal outlined>Adrenergic alpha-2 Receptor Agonists</Badge> <Badge intent="note" minimal outlined>Adult</Badge> <Badge intent="note" minimal outlined>Attention Deficit Disorder with Hyperactivity</Badge> <Badge intent="note" minimal outlined>Bupropion</Badge> <Badge intent="note" minimal outlined>Central Nervous System Stimulants</Badge> <Badge intent="note" minimal outlined>Child</Badge> <Badge intent="note" minimal outlined>Clonidine</Badge> <Badge intent="note" minimal outlined>Dose-Response Relationship, Drug</Badge> <Badge intent="note" minimal outlined>Humans</Badge> <Badge intent="note" minimal outlined>Methylphenidate</Badge> <Badge intent="note" minimal outlined>Randomized Controlled Trials as Topic</Badge>

## Citation

Cortese S, Adamo N, Del Giovane C, Mohr-Jensen C, Hayes AJ, Carucci S, et al. Comparative efficacy and tolerability of medications for attention-deficit hyperactivity disorder in children, adolescents, and adults: a systematic review and network meta-analysis. Lancet Psychiatry. 2018. doi:10.1016/S2215-0366(18)30269-4. PMID:30097390.
