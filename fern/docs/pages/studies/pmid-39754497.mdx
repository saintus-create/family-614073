...
<Badge intent="info">Cohort study</Badge> <Badge intent="info" minimal>2025</Badge> <Badge intent="note" minimal outlined>Safety & tolerability</Badge> <Badge intent="note" minimal outlined>Cardiovascular</Badge>
