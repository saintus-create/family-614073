...
<Badge intent="success">Meta-analysis</Badge> <Badge intent="info" minimal>2022</Badge> <Badge intent="note" minimal outlined>Efficacy</Badge> <Badge intent="note" minimal outlined>Safety & tolerability</Badge> <Badge intent="note" minimal outlined>Pharmacokinetics</Badge> <Badge intent="success" minimal>Free full text</Badge>
