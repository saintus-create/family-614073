...
<Badge intent="note">Review</Badge> <Badge intent="info" minimal>2005</Badge> <Badge intent="note" minimal outlined>Safety & tolerability</Badge> <Badge intent="note" minimal outlined>Pharmacokinetics</Badge>
