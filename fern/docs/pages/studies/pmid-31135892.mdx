...
<Badge intent="success">Meta-analysis</Badge> <Badge intent="info" minimal>2019</Badge> <Badge intent="note" minimal outlined>Efficacy</Badge> <Badge intent="note" minimal outlined>Safety & tolerability</Badge> <Badge intent="note" minimal outlined>Sleep</Badge> <Badge intent="success" minimal>Free full text</Badge>
