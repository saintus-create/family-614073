...
subtitle: "Cochrane Database Syst Rev · 2018 · PMID 29566425"
slug: pmid-29566425
---

<Badge intent="success">Meta-analysis</Badge> <Badge intent="info" minimal>2018</Badge> <Badge intent="note" minimal outlined>Safety & tolerability</Badge> <Badge intent="note" minimal outlined>Cognition & function</Badge> <Badge intent="note" minimal outlined>Comorbidity</Badge> <Badge intent="success" minimal>Free full text</Badge>
...
**Reported:** `SMD -0.16, 95% CI -0.52 to 0.19` · `SMD -1.22, 95% CI -2.03 to -0.41` · `SMD -0.84, 95% CI -1.18 to -0.50` · `SMD -0.80, 95% CI -1.31 to -0.30` · `SMD -0.58, 95% CI -0.98 to -0.17` · `SMD -0.44, 95% CI -0.88 to -0.01` · `SMD -0.36, 95% CI -0.60 to -0.11` · `SMD -0.45, 95% CI -0.71 to -0.19`
...
| Language | English |
| Sources | [PubMed 29566425](https://pubmed.ncbi.nlm.nih.gov/29566425/) · [DOI 10.1002/14651858.CD010840.pub2](https://doi.org/10.1002/14651858.CD010840.pub2) · [PMC6494390 full text](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6494390/) |
...
<Badge intent="note" minimal outlined>Adult</Badge> <Badge intent="note" minimal outlined>Anxiety Disorders</Badge> <Badge intent="note" minimal outlined>Attention Deficit Disorder with Hyperactivity</Badge> <Badge intent="note" minimal outlined>Cognitive Behavioral Therapy</Badge> <Badge intent="note" minimal outlined>Depression</Badge> <Badge intent="note" minimal outlined>Diagnostic Self Evaluation</Badge> <Badge intent="note" minimal outlined>Humans</Badge> <Badge intent="note" minimal outlined>Randomized Controlled Trials as Topic</Badge> <Badge intent="note" minimal outlined>Waiting Lists</Badge>

## Citation

Lopez PL, Torrente FM, Ciapponi A, Lischinsky AG, Cetkovich-Bakmas M, Rojas JI, et al. Cognitive-behavioural interventions for attention deficit hyperactivity disorder (ADHD) in adults. Cochrane Database Syst Rev. 2018. doi:10.1002/14651858.CD010840.pub2. PMID:29566425.
