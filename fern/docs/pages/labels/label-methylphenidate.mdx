...
Reproduced from the approved US label; sections are abridged for indexing. Read the [complete current label](https://dailymed.nlm.nih.gov/dailymed/drugInfo.cfm?setid=45d33807-88b2-4b42-9c86-e5b05d7adec1) before any clinical use. Requirements differ outside the United States.
</Callout>
